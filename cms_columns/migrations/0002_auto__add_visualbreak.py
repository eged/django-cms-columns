...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'VisualBreak'
        db.create_table('cmsplugin_visualbreak', (
            ('cmsplugin_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['cms.CMSPlugin'], unique=True, primary_key=True)),
            ('css_class', self.gf('django.db.models.fields.CharField')(default='visual-break', max_length=100, blank=True)),
        ))
        db.send_create_signal('cms_columns', ['VisualBreak'])


    def backwards(self, orm):
        
        # Deleting model 'VisualBreak'
        db.delete_table('cmsplugin_visualbreak')
